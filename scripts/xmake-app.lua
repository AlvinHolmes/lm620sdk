...
if os.getenv("USE_SDK") ~= "y" then
    ...
    --sdk版本
    if has_config("board") then
        add_includedirs(TOP_DIR .. "/board/" .. get_config("board"),{public = true})
    end
    add_includedirs(TOP_DIR .. "/components",{public = true})
	add_includedirs(TOP_DIR .. "/components/kernel/include",{public = true})
	add_includedirs(TOP_DIR .. "/components/driver/include",{public = true})
	add_includedirs(TOP_DIR .. "/components/at/inc",{public = true})
	add_includedirs(TOP_DIR .. "/components//net/lwip/lwip-2.1.2/src/include",{public = true})
	add_includedirs(TOP_DIR .. "/components//net/lwip/lwip-2.1.2/src/include/netif",{public = true})
	add_includedirs(TOP_DIR .. "/components//net/lwip/lwip-2.1.2/src/include/compat/posix",{public = true})
	add_includedirs(TOP_DIR .. "/components//net/lwip/port",{public = true})
	add_includedirs(TOP_DIR .. "/components//net/lwip/port/arch/include",{public = true})
...
includes(TOP_DIR .. "/vendor/app/xmake.lua")
