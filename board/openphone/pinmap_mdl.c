...
const PM_PINFUNC_T g_PinFunc_mdl[] = {
...
{LPUART0_CTS,            PIN_7_MUX_GPIO,             PIN_CFG_DIR | GPIO_OUT,
                                                    ...
                                                    .pinPull =  PULL_NONE,
                                                    .pinDir =   PIN_INPUT_ENABLE,
                                                    .gpioOut =  GPIO_LOW},  //BSP_USING_SPI  #if defined(_CPU_AP) && !defined(USE_TOP_MTS) && !defined(USE_TOP_MINI)
...
{CLK_EXT_OUT,            PIN_11_MUX_GPIO,            PIN_CFG_DIR | GPIO_OUT,
                                                    .pinDrv =   PIN_DRV_2,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_NONE,
                                                    .pinDir =   PIN_INPUT_ENABLE,
...
{PD_GPIO_0,              PIN_21_MUX_SSP0_CLK,        PIN_CFG_RATE,
                                                    ...
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_NONE,
                                                    .pinRate =  SLEW_RATE_LOW},  //BSP_USING_SPI  #if defined(_CPU_AP) && !defined(USE_TOP_MTS) && !defined(USE_TOP_MINI)
...
{PD_GPIO_4,              PIN_25_MUX_GPIO,            PIN_CFG_RATE | GPIO_OUT,
                                                    .pinDrv =   PIN_DRV_1,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_DOWN,
                                                    .pinRate =  SLEW_RATE_LOW,
...
{PD_GPIO_5,              PIN_26_MUX_GPIO,            PIN_CFG_RATE | GPIO_OUT,
                                                    .pinDrv =   PIN_DRV_1,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_DOWN,
                                                    .pinRate =  SLEW_RATE_LOW,
...
{PD_GPIO_6,              PIN_27_MUX_GPIO,            PIN_CFG_RATE | GPIO_OUT,
                                                    .pinDrv =   PIN_DRV_1,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_DOWN,
                                                    .pinRate =  SLEW_RATE_LOW,
...
{PD_GPIO_7,              PIN_28_MUX_GPIO,            PIN_CFG_RATE | GPIO_OUT,
                                                    .pinDrv =   PIN_DRV_1,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_DOWN,
                                                    .pinRate =  SLEW_RATE_LOW,
...
{PD_GPIO_8,              PIN_29_MUX_GPIO,            PIN_CFG_RATE,
                                                    .pinDrv =   PIN_DRV_1,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_NONE,
                                                    .pinRate =  SLEW_RATE_LOW},  //BUS_USING_SECOND_CARD  #if defined(_CPU_AP) && defined(USE_DUAL_CARD)

{PD_GPIO_9,              PIN_30_MUX_GPIO,            PIN_CFG_RATE,
                                                    .pinDrv =   PIN_DRV_1,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_NONE,
                                                    .pinRate =  SLEW_RATE_LOW},

{PD_GPIO_10,             PIN_31_MUX_GPIO,            PIN_CFG_RATE,
                                                    .pinDrv =   PIN_DRV_1,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_NONE,
                                                    .pinRate =  SLEW_RATE_LOW},

{PD_GPIO_11,             PIN_32_MUX_GPIO,            PIN_CFG_RATE | GPIO_OUT,
                                                    .pinDrv =   PIN_DRV_1,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_DOWN,
                                                    .pinRate =  SLEW_RATE_LOW,
...
{PD_GPIO_12,             PIN_33_MUX_UART1_RX,        PIN_CFG_RATE,
                                                    .pinDrv =   PIN_DRV_1,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_UP,
                                                    .pinRate =  SLEW_RATE_LOW},

{PD_GPIO_13,             PIN_34_MUX_UART1_TX,        PIN_CFG_RATE,
                                                    .pinDrv =   PIN_DRV_1,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_NONE,
                                                    .pinRate =  SLEW_RATE_LOW},

{PD_GPIO_14,             PIN_35_MUX_UART1_CTS,       PIN_CFG_RATE,
                                                    .pinDrv =   PIN_DRV_1,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_DOWN,
                                                    .pinRate =  SLEW_RATE_LOW},

{PD_GPIO_15,             PIN_36_MUX_UART1_RTS,       PIN_CFG_RATE,
                                                    .pinDrv =   PIN_DRV_1,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_DOWN,
                                                    .pinRate =  SLEW_RATE_LOW},
...
{RF_CONTROL_0,           PIN_40_MUX_GPIO,            PIN_CFG_RATE | GPIO_OUT,
                                                    .pinDrv =   PIN_DRV_1,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_DOWN,
                                                    .pinRate =  SLEW_RATE_LOW,
...
{RF_CONTROL_1,           PIN_41_MUX_GPIO,            PIN_CFG_RATE | GPIO_OUT,
                                                    .pinDrv =   PIN_DRV_1,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_DOWN,
                                                    .pinRate =  SLEW_RATE_LOW,
...
{RF_CONTROL_2,           PIN_42_MUX_GPIO,            PIN_CFG_RATE | GPIO_OUT,
                                                    .pinDrv =   PIN_DRV_1,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_DOWN,
                                                    .pinRate =  SLEW_RATE_LOW,
...
{RF_CONTROL_4,           PIN_44_MUX_GPIO,            PIN_CFG_RATE | GPIO_OUT,
                                                    .pinDrv =   PIN_DRV_1,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_DOWN,
                                                    .pinRate =  SLEW_RATE_LOW,
...
{RF_CONTROL_5,           PIN_45_MUX_GPIO,            PIN_CFG_RATE | GPIO_OUT,
                                                    .pinDrv =   PIN_DRV_1,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_DOWN,
                                                    .pinRate =  SLEW_RATE_LOW,
...
{PD_GPIO_16,             PIN_50_MUX_I2C2_SCL,        PIN_CFG_RATE,
                                                    .pinDrv =   PIN_DRV_2,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_NONE,
                                                    .pinRate =  SLEW_RATE_FAST},  //  BSP_USING_I2C  #if defined(_CPU_AP)

{PD_GPIO_17,             PIN_51_MUX_I2C2_SDA,        PIN_CFG_RATE,
                                                    .pinDrv =   PIN_DRV_1,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_NONE,
...
const int PINFUNC_SIZE_MDL = sizeof(g_PinFunc_mdl)/(sizeof(g_PinFunc_mdl[0]));
...
void prv_PIN_ConfigMdl(const PM_PINFUNC_T* pin)
{
...
int Board_MdlPinInit(void)
{

    for(uint8_t i = 0; i < PINFUNC_SIZE_MDL; i++)
    {
        prv_PIN_ConfigMdl(&g_PinFunc_mdl[i]);
    }

    return 0;
}
// INIT_BOARD_EXPORT(Board_MdlPinInit, OS_INIT_SUBLEVEL_HIGH);
#endif