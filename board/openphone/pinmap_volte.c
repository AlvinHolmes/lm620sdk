...
const PM_PINFUNC_T g_PinFunc_volte[] = {
...
{PD_GPIO_9,              PIN_30_MUX_GPIO,             PIN_CFG_RATE | GPIO_OUT,
                                                    .pinDrv =   PIN_DRV_1,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_DOWN,
                                                    .pinRate =  SLEW_RATE_LOW,
...
{PD_GPIO_10,             PIN_31_MUX_GPIO,             PIN_CFG_RATE | GPIO_OUT,
                                                    .pinDrv =   PIN_DRV_1,
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_DOWN,
                                                    .pinRate =  SLEW_RATE_LOW,
...
{PD_GPIO_16,             PIN_50_MUX_I2C2_SCL,         PIN_CFG_RATE,
                                                    ...
                                                    .pinSen =   SEN_ENABLE,
                                                    .pinPull =  PULL_DOWN,
                                                    .pinRate =  SLEW_RATE_FAST}, //CodecPin 50-51
...
const int PINFUNC_SIZE_VOLTE = sizeof(g_PinFunc_volte)/(sizeof(g_PinFunc_volte[0]));
...
void prv_PIN_ConfigVo(const PM_PINFUNC_T* pin)
{
...
int Board_VoltePinInit(void)
{

    for(uint8_t i = 0; i < PINFUNC_SIZE_VOLTE; i++)
    {
        prv_PIN_ConfigVo(&g_PinFunc_volte[i]);
    }

    return 0;
}
// INIT_BOARD_EXPORT(Board_VoltePinInit, OS_INIT_SUBLEVEL_HIGH);
#endif