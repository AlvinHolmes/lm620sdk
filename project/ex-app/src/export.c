...
RTM_EXPORT(osMallocTrace);
RTM_EXPORT(osFreeTrace);
RTM_EXPORT(osReallocTrace);
RTM_EXPORT(osCallocTrace);
RTM_EXPORT(osMallocAlignTrace);
RTM_EXPORT(osFreeAlignTrace);
 ...
 * svc & ps APIs
 */
RTM_EXPORT(Api_GetImei);
RTM_EXPORT(svc_eqp_read_boardnum);