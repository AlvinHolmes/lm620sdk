 ...
 *      - -1 on error. Refer to file system implementation for errno.
 */
void *vfs_opendir(const char *name);
 ...
 *      - -1 on error. Refer to file system implementation for errno.
 */
VFS_Dirent *vfs_readdir(void *dirp);
 ...
 *      - -1 on error. Refer to file system implementation for errno.
 */
int vfs_readdir_r(void *dirp, VFS_Dirent *entry, VFS_Dirent **result);
 ...
 *      - -1 on error. Refer to file system implementation for errno.
 */
void vfs_seekdir(void *pdir, long loc);
