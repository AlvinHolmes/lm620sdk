...
#ifndef   __SEGGER_RTL_CTZ_U32
  #define __SEGGER_RTL_CTZ_U32(X)               __SEGGER_RTL_CTZ_U32_inline(X)
  #define __SEGGER_RTL_CTZ_U32_SYNTHESIZED
#endif

#ifndef   __SEGGER_RTL_CTZ_U64
  #define __SEGGER_RTL_CTZ_U64(X)               __SEGGER_RTL_CTZ_U64_inline(X)
  #define __SEGGER_RTL_CTZ_U64_SYNTHESIZED
#endif

#ifndef   __SEGGER_RTL_FFS_U32
  #define __SEGGER_RTL_FFS_U32(X)               __SEGGER_RTL_FFS_U32_inline(X)
  #define __SEGGER_RTL_FFS_U32_SYNTHESIZED
#endif

#ifndef   __SEGGER_RTL_FFS_U64
  #define __SEGGER_RTL_FFS_U64(X)               __SEGGER_RTL_FFS_U64_inline(X)
  #define __SEGGER_RTL_FFS_U64_SYNTHESIZED
#endif
