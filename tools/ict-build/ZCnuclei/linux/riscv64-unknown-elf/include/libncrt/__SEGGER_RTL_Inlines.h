...
/*********************************************************************
*
*       __SEGGER_RTL_CTZ_U32_inline()
*
*  Function description
*    Count trailing zeros in a 32-bit integer, best method.
*
*  Parameters
*    x - Value to count trailing zeros.
*
*  Return value
*    Number of trailing zeros.
*/
static __SEGGER_RTL_ALWAYS_INLINE int __SEGGER_RTL_CTZ_U32_inline(__SEGGER_RTL_U32 x) {
  //
#if __SEGGER_RTL_OPTIMIZE <= 0
  return W_TYPE_SIZE - 1 - __SEGGER_RTL_CLZ_U32_compare_alg_inline(x & -x);
#elif __SEGGER_RTL_OPTIMIZE == 1
  return W_TYPE_SIZE - 1 - __SEGGER_RTL_CLZ_U32_shift_alg_inline(x & -x);
#else
  return W_TYPE_SIZE - 1 - __SEGGER_RTL_CLZ_U32_lut_alg_inline(x & -x);
#endif
}

/*********************************************************************
*
*       __SEGGER_RTL_FFS_U32_inline()
*
*  Function description
*    Returns one plus the index of the least significant 1-bit in a 32-bit integer, best method.
*
*  Parameters
*    x - Value to ffs.
*
*  Return value
*    index of the least significant 1-bit in a 32-bit integer.
*/
static __SEGGER_RTL_ALWAYS_INLINE int __SEGGER_RTL_FFS_U32_inline(__SEGGER_RTL_U32 x) {
  //
  if (x == 0) {
    return 0;
  }
  //
#if __SEGGER_RTL_OPTIMIZE <= 0
  return W_TYPE_SIZE - __SEGGER_RTL_CLZ_U32_compare_alg_inline(x & -x);
#elif __SEGGER_RTL_OPTIMIZE == 1
  return W_TYPE_SIZE - __SEGGER_RTL_CLZ_U32_shift_alg_inline(x & -x);
#else
  return W_TYPE_SIZE - __SEGGER_RTL_CLZ_U32_lut_alg_inline(x & -x);
#endif
}
...
/*********************************************************************
*
*       __SEGGER_RTL_CTZ_U64_inline()
*
*  Function description
*    Count trailing zeros in a 64-bit integer, best method.
*
*  Parameters
*    x - Value to count trailing zeros.
*
...
*    Number of trailing zeros.
*/
static __SEGGER_RTL_ALWAYS_INLINE int __SEGGER_RTL_CTZ_U64_inline(__SEGGER_RTL_U64 x) {
  if (__SEGGER_RTL_U64_L(x) == 0) {
    return 32 + __SEGGER_RTL_CTZ_U32(__SEGGER_RTL_U64_H(x));
  } else {
    return __SEGGER_RTL_CTZ_U32(__SEGGER_RTL_U64_L(x));
  }
}

/*********************************************************************
*
*       __SEGGER_RTL_FFS_U64_inline()
*
*  Function description
*    Returns one plus the index of the least significant 1-bit in a 64-bit integer, best method.
*
*  Parameters
*    x - Value to ffs.
*
*  Return value
*    index of the least significant 1-bit in a 64-bit integer.
*/
static __SEGGER_RTL_ALWAYS_INLINE int __SEGGER_RTL_FFS_U64_inline(__SEGGER_RTL_U64 x) {
  if (__SEGGER_RTL_U64_L(x) != 0) {
    return __SEGGER_RTL_FFS_U32(__SEGGER_RTL_U64_L(x));
  } else if (__SEGGER_RTL_U64_H(x) != 0) {
    return __SEGGER_RTL_FFS_U32(__SEGGER_RTL_U64_H(x)) + 32;
  } else {
    return 0;
  }
}
