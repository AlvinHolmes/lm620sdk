...
#include MG_CUSTOM_MEMORY_INCLUDE

#undef malloc
#define malloc(s)       MG_CUSTOM_MALLOC((s))

#undef calloc
#define calloc(c, s)    MG_CUSTOM_CALLOC((c), (s))

#undef free
#define free(p)         MG_CUSTOM_FREE((p))
