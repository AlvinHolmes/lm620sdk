...
#ifdef MG_BUILD_LOG_LEVEL

#if MG_BUILD_LOG_LEVEL >= MG_BUILD_LOG_ERROR
#define MG_ERROR(args) MG_LOG(MG_LL_ERROR, args)
#else
#define MG_ERROR(args)
#endif

#if MG_BUILD_LOG_LEVEL >= MG_BUILD_lOG_INFO
#define MG_INFO(args) MG_LOG(MG_LL_INFO, args)
#else
#define MG_INFO(args)
#endif

#if MG_BUILD_LOG_LEVEL >= MG_BUILD_LOG_DEBUG
#define MG_DEBUG(args) MG_LOG(MG_LL_DEBUG, args)
#else
#define MG_DEBUG(args)
#endif

#if MG_BUILD_LOG_LEVEL >= MG_BUILD_LOG_VERBOSE
